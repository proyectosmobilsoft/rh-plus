    ...
    <div className="page-container p-6">
      <div className="page-header mb-6">
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-red-800">Crear Administrador</h1>
            <p className="text-gray-600">
              Crea una nueva cuenta de administrador con permisos completos
            </p>
          </div>
        </div>
      </div>
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="admin.usuario" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <div className="bg-red-50 p-4 rounded-lg border border-red-200">
                  <h3 className="font-medium text-red-800 mb-2">Información importante:</h3>
                  <ul className="text-sm text-red-700 space-y-1">
                    <li>• El administrador tendrá acceso completo al sistema</li>
